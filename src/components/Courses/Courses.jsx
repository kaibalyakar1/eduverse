...
<VStack className='course' alignItems={['center', 'flex-start']}>
   ...
   <Heading textAlign={["center","left"]} maxW={"200px"} fontFamily={"sans-serif"} size={'sm'}
...
<Button colorScheme='yellow'>Watch Now</Button>
  ...
  const Courses = () => {
    ...
    const categories = [
      "Web development", "Artificial Intelligence","Data Structure", "App Development", "Game Development"]
